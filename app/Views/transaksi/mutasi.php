...
$(document).ready(function() {
    ...
    // Update stock saat gudang asal berubah
    ...
    $('#modal_id_kayu').change(function() {
        ...
        if (!idKayu || !currentGudangAsal) {
            $('#modal_stock').val(0);
            return;
        }
        
        // Cari stock dari data yang sudah diload
        const stock = getStock(idKayu, currentGudangAsal);
    ...
    function renderItems() {
        ...
        items.forEach((item, index) => {
            ...
            item.stock = getStock(item.id_kayu, currentGudangAsal);
